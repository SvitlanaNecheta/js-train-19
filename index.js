...
console.log(Object.getPrototypeOf(Biography)===Novel);// Перевіримо чи являється Novel прототипом Biography та виведемо в консоль
...
Object.defineProperty(ScienceBook,'info',{value:'INFO',configurable:false});// Додаємо властивість 'info' за допомогою Object.defineProperty
...
console.log(ScienceBook.info);// Виводимо в консоль властивість info

console.log(Object.getOwnPropertyDescriptor(ScienceBook,"info"));// Виводимо в консоль налаштування властивости info
...
Textbook.read=function(){return `Ви читаєте підручник ${this.title} від ${this.author}. ${this.info}`};
...
console.log(Textbook.read());// Викликаємо функцію read об'єкту Textbook

// 6. Абстракція: створення об'єкта з загальними властивостями
let Media={
    format:"Загальний Формат",
    length:0,
    play(){return `Зараз відтворюється медіа у форматі ${this.format} з тривалістю ${this.length} секунд`},
}
/*
 * Об'єкт: Media
 * Властивості:
...
console.log(Song.play());// Викликаємо функцію play об'єкту Song
